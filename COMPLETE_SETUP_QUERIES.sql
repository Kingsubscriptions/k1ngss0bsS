...
ARRAY['Access to GPT-4', 'Faster response times', 'Priority access to new features', 'Available even during peak times'],
'{"monthly": 1200, "yearly": 4000, "original": 5500}'::jsonb, true, 4.9, 'Popular', NOW(), NOW()),
...
ARRAY['AI code suggestions', 'Multi-language support', 'IDE integration', 'Context-aware completions'],
...
ARRAY['100M+ premium photos & graphics', 'Brand Kit & templates', 'Background remover', 'Team collaboration'],
'{"monthly": 400, "yearly": 4500, "original": 1500}'::jsonb, true, 4.9, 'Best Seller', NOW(), NOW()),
...
ARRAY['Photoshop, Illustrator, Premiere Pro', '100GB cloud storage', 'Adobe Fonts access', 'All latest updates'],
'{"monthly": 1500, "yearly": 16000, "original": 8000}'::jsonb, true, 4.8, 'Premium', NOW(), NOW()),
...
ARRAY['4K Ultra HD streaming', '4 screens simultaneously', 'Unlimited downloads', 'No ads'],
...
ARRAY['Ad-free listening', 'Offline downloads', 'High quality audio', 'Unlimited skips'],
'{"monthly": 300, "yearly": 3500, "original": 550}'::jsonb, true, 4.9, 'Best Seller', NOW(), NOW()),
...
ARRAY['Ad-free videos', 'Background play', 'YouTube Music included', 'Offline downloads'],
'{"monthly": 280, "yearly": 3200, "original": 899}'::jsonb, true, 4.8, NULL, NOW(), NOW()),

-- Microsoft & Office
('microsoft-365', 'Microsoft 365', 'Productivity,Software', 'Complete Microsoft Office suite with cloud services', '/images/products/office-logo.png',
ARRAY['Word, Excel, PowerPoint, Outlook', '1TB OneDrive storage', 'Premium Office apps', 'Works on 5 devices'],
'{"monthly": 500, "yearly": 5500, "original": 1800}'::jsonb, true, 4.8, 'Popular', NOW(), NOW()),
...
ARRAY['Lifetime activation', 'All Pro features', 'BitLocker encryption', 'Remote Desktop'],
...
ARRAY['7000+ courses', 'Professional certificates', 'University degrees', 'Learn at your own pace'],
'{"monthly": 1500, "yearly": 16000, "original": 8000}'::jsonb, true, 4.9, 'New', NOW(), NOW()),
...
ARRAY['8000+ courses', 'Expert instructors', 'Certificates of completion', 'Mobile app access'],
'{"monthly": 800, "yearly": 9000, "original": 8400}'::jsonb, true, 4.7, NULL, NOW(), NOW()),
...
ARRAY['Keyword research', 'Competitor analysis', 'Site audit', 'Rank tracking'],
'{"monthly": 3500, "yearly": 38000, "original": 36000}'::jsonb, true, 4.8, 'Premium', NOW(), NOW()),

('ahrefs-lite', 'Ahrefs Lite', 'SEO Tools,Marketing', 'Powerful SEO tools for backlink analysis', '/images/products/ahrefs-logo.png',
ARRAY['Backlink checker', 'Keyword explorer', 'Site explorer', 'Rank tracker'],
...
ARRAY['5500+ servers worldwide', 'Military-grade encryption', 'No logs policy', '6 devices simultaneously'],
'{"monthly": 600, "yearly": 6500, "original": 1200}'::jsonb, true, 4.8, NULL, NOW(), NOW()),

-- Gaming
('discord-nitro', 'Discord Nitro', 'Gaming,Social Media', 'Enhanced Discord experience with perks', '/images/products/discord-logo.png',
ARRAY['Custom emojis anywhere', 'HD video streaming', 'Server boosts', 'Larger uploads'],
